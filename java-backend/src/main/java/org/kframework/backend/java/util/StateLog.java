...
public class StateLog {
    ...
    public static enum LogEvent {
        OPEN, REACHINIT, REACHTARGET, REACHPROVED, REACHUNPROVED, EXECINIT, SEARCHINIT, SEARCHREACH, NODE, RULE, SRULE, RULEATTEMPT, SRULEATTEMPT, FRULE, IMPLICATION, Z3QUERY, Z3RESULT, CLOSE, CHECKINGCONSTRAINT
    }
