...
public final class JavaExecutionOptions {
    ...
    @Parameter(names={"--state-log-events"}, converter=LogEventConverter.class, description="Comma-separated list of events to log: [OPEN|REACHINIT|REACHTARGET|REACHPROVED|REACHUNPROVED|EXECINIT|SEARCHINIT|SEARCHREACH|NODE|RULE|SRULE|RULEATTEMPT|SRULEATTEMPT|FRULE|CHECKINGCONSTRAINT|IMPLICATION|Z3QUERY|Z3RESULT|CLOSE]")
